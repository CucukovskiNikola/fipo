  ...
  >
    ...
    >
      <div class="relative group">
        ...
        >
          <i class="pi pi-cog text-lg group-hover:rotate-90 transition-transform duration-300"></i>
        </button>
...
import { useCookieManager, CONSENT_STATUS } from '@/composables/useCookieManager'
