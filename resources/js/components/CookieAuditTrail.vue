<template>
  <div class="space-y-4">
    ...
    <div v-if="auditTrail.length === 0" class="text-center py-8 text-white/50">
      <i class="pi pi-history text-2xl mb-2 block"></i>
            ...
            <div class="min-w-0 flex-1">
              ...
              <div v-if="entry.metadata && Object.keys(entry.metadata).length > 0" class="mt-2">
                <details class="text-xs">
                  <summary class="text-white/50 hover:text-white/70 cursor-pointer">
                    Metadata
                  </summary>
                  <div class="mt-1 p-2 bg-black/20 rounded text-white/60 font-mono text-xs">
    ...
    <div class="text-xs text-white/40 text-center pt-2 border-t border-white/10">
